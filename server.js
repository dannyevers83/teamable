...
const url = `mongodb://${DB_USER}:${DB_PASS}@${dbAddress}?authSource=company_db`;

// skips credentials when on local machine
// const url = DEV
//   ? `mongodb://${dbAddress}`
//   : `mongodb://${DB_USER}:${DB_PASS}@${dbAddress}?authSource=company_db`;
